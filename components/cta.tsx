    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset="1" stopColor="#B8E600" stopOpacity="0" />
        </motion.linearGradient>
        <linearGradient
    ...
    <div className="bg-black w-full max-w-7xl mx-auto min-h-[80vh] md:min-h-[100dvh] flex items-center justify-center px-4 sm:px-6 lg:px-8 relative">
      ...
      >
        <div className="relative z-20">
          <h2
            className={cn(
              ...
              "bg-gradient-to-b from-[#E8E8E8] via-[#FFFFFF] to-[#E8E8E8]",
              "bg-clip-text text-transparent",
              "px-4 md:px-8"
            )}
          >
            Train Smarter. Earn More. Live Better.
          </h2>
        ...
        >
          <Link
            href="/signup"
            className="inline-flex items-center justify-center bg-[#CCFF00] text-black font-semibold text-base px-8 py-4 rounded-lg hover:bg-[#B8E600] active:scale-[0.98] transition-all duration-150 min-h-[56px]"
          >
            Get Started Free →
          </Link>
        </motion.div>
