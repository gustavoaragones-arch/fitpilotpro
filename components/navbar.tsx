        ...
        <AnimatePresence mode="popLayout" initial={false}>
          {!visible && (
            ...
            >
              <Link
                href="/signup"
                className="hidden md:inline-flex items-center justify-center bg-[#CCFF00] text-black font-semibold text-sm px-5 py-2.5 rounded-lg hover:bg-[#B8E600] active:scale-[0.98] transition-all duration-150 min-h-[40px]"
              >
                Get Started Free
              </Link>
            </motion.div>
