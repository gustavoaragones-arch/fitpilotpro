...
import { Users, MapPin, Brain, TrendingUp, Share2, DollarSign } from "lucide-react";
import { GlowingEffect } from "./ui/glowing-effect";

const FEATURE_ITEMS = [
  {
    icon: Users,
    title: "Smart Client Tiers",
    body: "Automatic Diamond, Gold, and Silver classification. Know exactly which clients drive your revenue — before you even check your bank account.",
  },
  {
    icon: MapPin,
    title: "Route Optimization",
    body: "Stop wasting 2 hours driving inefficient routes. FitPilot calculates the shortest path between all your daily sessions automatically.",
  },
  {
    icon: Brain,
    title: "AI Scheduling",
    body: "Claude-powered scheduling that accounts for client fatigue, goals, and your availability. Your calendar, optimized.",
  },
  {
    icon: TrendingUp,
    title: "Business Analytics",
    body: "Revenue trends, session completion rates, client retention, and tier-split revenue charts. Make decisions from data, not gut feeling.",
  },
  {
    icon: Share2,
    title: "Social Export",
    body: "Generate branded progress graphics for Instagram, TikTok, and YouTube in one click. Client consent built in.",
  },
  {
    icon: DollarSign,
    title: "Payment Tracking",
    body: "Log payments, track outstanding invoices, and export directly to QuickBooks. Bookkeeping done.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p className="max-w-lg text-sm text-center mx-auto mt-4 text-neutral-400">
        The professional business management platform built exclusively for personal trainers.
      </p>
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {FEATURE_ITEMS.map((item, idx) => (
          <Card key={idx} className="flex flex-col relative justify-between min-h-[220px]">
            <CardContent className="p-6">
              <div className="w-10 h-10 rounded-lg bg-[#CCFF00]/20 flex items-center justify-center mb-4">
...
// Card structure (kept for potential reuse)
...
const CardTitle = ({
  ...
  return (
    <h3
      className={cn(
        "inline-block text-[15px] md:text-lg bg-[radial-gradient(61.17%_178.53%_at_38.83%_-13.54%,#E8E8E8_0%,#888787_12.61%,#FFFFFF_50%,#888787_80%,#E8E8E8_100%)]  bg-clip-text text-transparent",
        className
      )}
    >
      {children}
