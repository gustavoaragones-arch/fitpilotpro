    ...
    return (
      <div className="w-full max-w-[420px] text-center">
        <div className="bg-[#1E1E1E] border border-[#2A2A2A] rounded-2xl p-8">
          <div className="w-16 h-16 bg-[#CCFF00]/10 rounded-2xl flex items-center justify-center mx-auto mb-5">
          ...
          <p className="text-xs text-[#555]">
            Click the link to activate your account and start your 14-day free
            trial.
          </p>
          <Link
            href="/login"
            className="inline-flex items-center justify-center mt-6 text-sm text-[#CCFF00] font-medium hover:text-[#B8E600] transition-colors"
          >
            Back to login
          </Link>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#111] border border-[#2A2A2A] rounded-lg pl-10 pr-11 py-2.5 text-white text-sm placeholder:text-[#444] focus:outline-none focus:border-[#CCFF00] focus:ring-1 focus:ring-[#CCFF00]/20 transition-colors min-h-[44px]"
              />
              <button
                type="button"
          ...
          <div className="flex items-start gap-3">
            <input
              ...
              type="checkbox"
              id="terms"
              className="mt-0.5 w-4 h-4 rounded border-[#2A2A2A] bg-[#111] accent-[#CCFF00] cursor-pointer flex-shrink-0"
            />
            <label
              htmlFor="terms"
              className="text-xs text-[#A0A0A0] cursor-pointer leading-relaxed"
            >
              I agree to the{" "}
              <Link
                href="/terms"
                className="text-[#CCFF00] hover:text-[#B8E600]"
              >
                Terms of Service
              </Link>{" "}
              and{" "}
          ...
          <button
            ...
            className="w-full bg-[#CCFF00] text-black font-semibold text-sm rounded-lg py-3 hover:bg-[#B8E600] active:scale-[0.98] transition-all min-h-[48px] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
          >
